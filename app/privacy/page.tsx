...
export default function PrivacyPage() {
  const sections = [
    ...
    },
    {
      ...
      body:
        "利用者が入力する資産名、資産金額、毎月の積立額、メモなどの情報は、サービス内で資産状況を表示し、次の行動を整理するために利用します。パスワード、秘密鍵、クレジットカード番号などの機密情報は入力しないでください。",
    },
    {
      title: "5. AI相談機能で入力される情報の取り扱い",
      body:
        "AI相談に入力された内容は、回答生成、品質改善、不具合調査のために利用される場合があります。個人を特定できる情報、金融機関の認証情報、秘密情報、第三者の個人情報などはAI相談へ入力しないでください。",
    },
    {
      title: "6. アクセス解析ツール",
      body:
    ...
    },
    {
      ...
      body:
        "当サービスでは、ホスティング、データ保存、AI回答、アクセス解析などのために外部サービスを利用する場合があります。法令に基づく場合を除き、利用者の同意なく個人情報を第三者へ販売することはありません。",
    },
    {
      title: "9. 情報の保存・安全管理",
      body:
    ...
    },
    {
      ...
      body:
        "利用者は、サービス内で入力した情報を自身の判断で管理してください。不要な情報は削除し、正確性が必要な情報は利用者自身で確認してください。",
    },
    {
    ...
    },
    {
      ...
      body:
        "当サービスは、必要に応じて本ポリシーを改定する場合があります。重要な変更がある場合は、サービス上で分かりやすい形でお知らせします。",
    },
  ];
